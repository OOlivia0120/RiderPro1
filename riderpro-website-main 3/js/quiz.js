// RiderPro Quiz - Scenario Questions
const quizQuestions = [
    {
...
function showResults() {
    ...
    let message = '';
    if (accuracy >= 90) {
        message = '🏆 Excellent! You have mastered professional delivery skills!';
    } else if (accuracy >= 70) {
        message = '👍 Good job! Keep working to improve your service level!';
    } else if (accuracy >= 60) {
        message = '💪 Passing grade! You need to strengthen your scenario handling abilities.';
    } else {
        message = '📚 Needs improvement. We recommend reviewing the relevant courses.';
    }
